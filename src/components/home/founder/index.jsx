...
const Founder = () => {
    const FounderMember = [
        ...
        },
        {
            ...
            image: "https://media.licdn.com/dms/image/D4D35AQHIg2E4rHe59g/profile-framedphoto-shrink_800_800/0/1700774406443?e=1714154400&v=beta&t=1KnAOu_eaKeuM8RTupMtZ2WRNf7_PNhSM6lfh7czVQY",
    ...
    return (
        <section className="bg-white mx-auto max-w-screen-xl">
            <div className="container px-6 py-10 mx-auto">
                <h1 className="text-2xl font-semibold text-center text-gray-800 capitalize lg:text-3xl "> Our Founder 
                ...
                <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-16 md:grid-cols-2 xl:grid-cols-2">
                    {FounderMember.map((member) => {
                        return (
                            <div key={member.id} className="flex flex-col items-center p-8 transition-colors duration-300 transform cursor-pointer group hover:bg-blue-500 rounded-xl">
                                <img className="object-cover w-48 h-48 rounded-full ring-4 ring-gray-300" src={member.image} alt={member.name} />
